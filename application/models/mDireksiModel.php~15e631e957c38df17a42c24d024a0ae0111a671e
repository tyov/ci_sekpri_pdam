...
class MDireksiModel extends CI_Model {
	...
	public function newData()
	{
		...
		//$ID_DIREKSI = $this->db->query("select dbo.getNomorJenisEkspedisi() as baru")->row_array();

		$data = array(
		       // 'ID_DIREKSI' => $ID_DIREKSI['baru'], -- identity
		        'DIREKSI' => $DIREKSI
		);
...
/* End of file mDireksiModel.php */
/* Location: ./application/models/mDireksiModel.php */